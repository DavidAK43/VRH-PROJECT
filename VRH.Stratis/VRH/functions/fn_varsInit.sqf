/*
	Author: Iceman77
	Parent File: cfgFunctions >> functions.hpp >> postInit = 1
	Description:
		Add the addaction and EH to the player object
*/
...
player addAction [
	...
	true,
	"",
	"{ cursorTarget isKindOf _x } count [ 'ReammoBox_F','Land_Pallet_MilBoxes_F','Land_PaperBox_open_full_F' ] > 0 && { _target distance cursorTarget <= 5 }"
];  
